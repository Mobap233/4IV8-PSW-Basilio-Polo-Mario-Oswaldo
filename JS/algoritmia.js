...
function problema3(){
    ...
    for( var palabra of p3_array){

        if(palabra.length > max_palabra.length){
            max_palabra = palabra;
        }

        var P3_input = max_palabra.split("");

        var P_num = P3_input.length;
    }

    document.querySelector('#p3-output').textContent = P_num + "(" + P3_input + ")";
